/*
 * ! jQuery Form Plugin version: 3.14 (30-JUL-2012) @requires jQuery v1.3.2 or
 * later
 * 
 * Examples and documentation at: h\t\t\p\:\/\/malsup.com/jquery/form/ Project
 * repository: https://github.com/malsup/form Dual licensed under the MIT and
 * GPL licenses: h\t\t\p\:\/\/malsup.github.com/mit-license.txt
 * h\t\t\p\:\/\/malsup.github.com/gpl-license-v2.txt
 */
...
(function($) {
	...
	$.fn.ajaxSubmit = function(options) {
		...
		// fast fail if nothing selected (h\t\t\p\s:\/\/dev.jquery.com/ticket/2752)
		if (!this.length) {
		...
		if (options.iframe !== false && (options.iframe || shouldUseFrame)) {
			...
			// see:
			// h\t\t\p\s:\/\/groups.google.com/group/jquery-dev/browse_thread/thread/36395b7ab510dd5d
	...
	$.fn.ajaxForm = function(options) {
		...
		if (!options.delegation && this.length === 0) {
			...
			// is your DOM ready?
			// h\t\t\p\s:\/\/docs.jquery.com/Tutorials:Introducing_$(document).ready()
