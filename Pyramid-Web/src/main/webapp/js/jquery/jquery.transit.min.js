/*
 * ! jQuery Transit - CSS3 transitions and transformations Copyright(c) 2011
 * Rico Sta. Cruz <rico@ricostacruz.com> MIT Licensed.
 * 
 * h\t\t\p\:\/\/ricostacruz.com/jquery.transit
 * h\t\t\p\:\/\/github.com/rstacruz/jquery.transit
 */
(function(d) {
	function k(a) {
		var b = ["Moz", "Webkit", "O", "ms"], c = a.charAt(0).toUpperCase()
				+ a.substr(1);
		if (a in i.style)
			return a;
	...
	function g(a, b) {
		return "string" === typeof a && !a.match(/^[\-0-9\.]+$/) ? a : "" + a
				+ b
	}
	function n(a) {
	...
	var i = document.createElement("div"), e = {}, s = -1 < navigator.userAgent
	...
	d.cssHooks.transform = {
		...
		set : function(a, b) {
			...
			a.style[e.transform] = "WebkitTransform" === e.transform && !s ? c
					.toString(!0) : c.toString();
	...
	j.prototype = {
		...
		set : function(a) {
			...
			this.setter[a] ? this.setter[a].apply(this, b) : this[a] = b
					.join(",")
		},
		get : function(a) {
		...
		toString : function(a) {
			...
			for (c in this)
				if (this.hasOwnProperty(c)
						&& (e.transform3d || !("rotateX" === c
								|| "rotateY" === c || "perspective" === c || "transformOrigin" === c)))
					"_" !== c[0]
							&& (a && "scale" === c ? b.push(c + "3d(" + this[c]
									+ ",1)") : a && "translate" === c ? b
									.push(c + "3d(" + this[c] + ",0)") : b
									.push(c + "(" + this[c] + ")"));
			return b.join(" ")
		}
	};
	d.fn.transition = d.fn.transit = function(a, b, c, f) {
		...
		"undefined" !== typeof a.duration
				&& (b = a.duration, delete a.duration);
		...
		var b = n(b), j = q(a, b, c, g), l = d.transit.enabled && e.transition
