...
<!--[if lt IE 9]>
<%--       <script src="<%=path%>/html5shiv/3.7.3/html5shiv.min.js"></script> --%>
<%--       <script src="<%=path%>/respond.js/1.4.2/respond.min.js"></script> --%>
    <![endif]-->
</head>
...
<body>
        ...
        <div class="container-fluid">
            <div class="menu style-1">
                <ul class="menu">
                    ...
                    <li><a href="http://sc.chinaz.com/?advertise/">Advertise</a></li>
                    <li><a
                        href="http://sc.chinaz.com/?write-for-us/">Write
                            For Us</a></li>
    ...
    <script>
					window.jQuery
							|| document
									.write('<script src="<%=path%>/js/jquery/jquery.min.js"><\/script>')
				</script>
