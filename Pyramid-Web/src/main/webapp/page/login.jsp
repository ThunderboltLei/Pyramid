...
<body>
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<%=basePath%>"
                    style="margin-top: -10px; line-height: 40px;"> <img style="float: left;"
                    alt="PYRAMID" src="<%=path%>/img/PYRAMID.png"> PYRAMID
                </a>
            </div>
            <div class="navbar-collapse collapse">
                <form id="loginForm" method="post" action="" login-form="login-form"
                    class="navbar-form navbar-right" role="form">
                    <div class="form-group">
                        <input input-email="input-email" type="text" placeholder="E-Mail / 用户名"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <input input-password="input-password" type="password" placeholder="登录密码"
                            class="form-control">
                    </div>
                    <button button-login="button-login" type="submit" class="btn btn-info">登录</button>
                    <button button-register="button-register" type="submit" class="btn btn-warning">注册</button>
                </form>
            </div>
            <!--/.navbar-collapse -->
        </div>
    ...
    <div class="container-fluid" style="height: 515px; margin-top: 65px;">
        <div class="carousel slide" id="login-carousel" data-ride="carousel">
            <ol class="carousel-indicators">
                <li class="active" data-target="#login-carousel" data-slide-to="0"></li>
                <li data-target="#login-carousel" data-slide-to="1"></li>
                <li data-target="#login-carousel" data-slide-to="2"></li>
            </ol>
            <div class="carousel-inner">
                <div class="item active" align="center">
                    <div id="slide_one" align="center" style="width: 99.5%">
                        <%-- <img alt="hello" src="<%=path%>/img/01.jpg"> --%>
                    </div>
                    <!--                     <div class="carousel-caption"> -->
                    <!--                         <h4>第一个滑动页</h4> -->
                    <!--                         <p style="font-size: 15px;">Nulla vitae elit libero, a pharetra augue -->
                    <!--                             mollis interdum.</p> -->
                    <!--                     </div> -->
                </div>
                <div class="item">
                    <div id="slide_two" align="center" style="width: 97%">
                        <%-- <img alt="hello" src="<%=path%>/img/01.jpg"> --%>
                    </div>
                    <!--                     <img alt="900x500" -->
                    ...
                    <!--                         <h4>第二个滑动页</h4> -->
                    <!--                         <p style="font-size: 15px;">Lorem ipsum dolor sit amet, consectetur -->
                    <!--                             adipiscing elit.</p> -->
                    <!--                     </div> -->
                </div>
                <div class="item">
                    <div id="slide_three" align="center" style="width: 97%">
                        <%-- <img alt="hello" src="<%=path%>/img/01.jpg"> --%>
                    </div>
                    <!--                     <div align="center"> -->
                    <%--                         <img alt="hello" src="<%=path%>/img/01.jpg" --%>
                    ...
                    <!--                     <div class="carousel-caption"> -->
                    <!--                         <h4>第三个滑动页</h4> -->
                    <!--                         <p style="font-size: 15px;">Praesent commodo cursus magna, vel -->
                    <!--                             scelerisque nisl consectetur.</p> -->
                    <!--                     </div> -->
                </div>
            </div>
            <a class="carousel-control left" role="button" href="#login-carousel" data-slide="prev" style="width: 25px">
                <span class="glyphicon glyphicon-chevron-left"></span>
            </a> <a class="carousel-control right" role="button" href="#login-carousel"
                data-slide="next" style="width: 25px"> <span class="glyphicon glyphicon-chevron-right"></span>
            </a>
        </div>
    </div>
    <!-- 3. footer -->
