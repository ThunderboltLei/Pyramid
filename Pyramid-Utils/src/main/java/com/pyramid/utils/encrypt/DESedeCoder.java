 ...
 * 
 * @Author: lm8212<br>
 * @Date: 2014年8月23日 下午9:25:15<br>
 * @Project: Pyramid-Utils<br>
 * @Package: com.pyramid.utils.encrypt<br>
 * @File: DESedeCoder.java<br>
 * @Description: DESede Coder<br/>
 *               secret key length: 112/168 bit, default: 168 bit<br/>
 *               mode: ECB/CBC/PCBC/CTR/CTS/CFB/CFB8 to CFB128/OFB/OBF8 to
 *               OFB128<br/>
 *               padding: Nopadding/PKCS5Padding/ISO10126Padding/<br>
 */
public class DESedeCoder {
	...
	public static void main(String[] args) throws Exception {
		...
		// System.out.println("key[" + key.length + "]：" + showByteArray(key));
		//
		// Key k = toKey(key);
		//
		// // String data ="DESede数据";
		// String data = "61.242.168.67";
		// System.out.println("加密前数据: string:" + data);
		// System.out.println("加密前数据: byte[" + data.getBytes().length + "]:"
		// + showByteArray(data.getBytes()));
		// System.out.println();
		// byte[] encryptData = encrypt(data.getBytes(), k);
		// System.out.println("加密后数据: byte[" + encryptData.length + "]:"
		// + showByteArray(encryptData));
		// System.out.println("加密后数据: hexStr:"
		// + String.valueOf(Hex.encodeHex(encryptData)));
		// System.out.println();
